...
const textArray = ['Front End', 'Programmer','Data Analyst','ML Engineer'],
  typingDelay = 50,
  erasingDelay = 50,
  newTextDelay = 2500;
...
charLimit.innerHTML = `Max Limit ${CHAR_LIMIT} characters`;
...
: 'Use the scroll wheel to scroll sideways and click on the image to open';
...
copy.innerHTML = `Copyright &copy 2024 - ${new Date().getFullYear()} - Charanvardhan Reddy. All rights reserved`;
...
const myBirthDate = new Date('1999-04-16');
...
age.forEach((item) => item.innerHTML = `${currentAge} Years`);
